...
data class FunctionDeclaration(val name: String, val returnType: Type, val paramTypes: List<Type>, val varargs: Boolean = false) {
    fun signature() : String {
        val paramsAsString = mutableListOf<String>()
...
class ModuleBuilder {
    ...
    private val importedDeclarations = mutableListOf<String>()
    private val importedDefinitions = mutableListOf<String>()
    private val declarations = mutableListOf<FunctionDeclaration>()
    private val functions = mutableListOf<FunctionBuilder>()
    private val globalVariables = mutableListOf<GlobalVariable>()
